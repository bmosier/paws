...
<html>
	...
	<body>
		...
		a record with a Foster Animal ID of 177, an Animal ID of 90, a Foster ID of 100, and any date. The insert should be successful
		...
		with a Foster Animal ID of 188, an Animal ID of 91, a Foster ID of 100, and any date. This will fail and give the appropriate
